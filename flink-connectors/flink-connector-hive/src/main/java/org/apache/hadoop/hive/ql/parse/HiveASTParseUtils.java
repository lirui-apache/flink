...
public class HiveASTParseUtils {
	 ...
	 */
	public static ASTNode parse(String command, HiveParserContext ctx) throws ParseException {
	...
	public static ASTNode parse(
			String command, HiveParserContext ctx, String viewFullyQualifiedName) throws ParseException {
