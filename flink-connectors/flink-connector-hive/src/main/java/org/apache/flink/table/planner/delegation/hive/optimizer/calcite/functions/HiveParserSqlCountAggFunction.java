...
public class HiveParserSqlCountAggFunction extends SqlAggFunction implements HiveParserSqlFunctionConverter.CanAggregateDistinct {
	...
	public HiveParserSqlCountAggFunction(boolean isDistinct, SqlReturnTypeInference returnTypeInference,
	...
	class HiveCountSplitter extends SqlSplittableAggFunction.CountSplitter {
		...
		public AggregateCall other(RelDataTypeFactory typeFactory, AggregateCall e) {
			...
			return AggregateCall.create(
					new HiveParserSqlCountAggFunction(isDistinct, returnTypeInference, operandTypeInference, operandTypeChecker),
