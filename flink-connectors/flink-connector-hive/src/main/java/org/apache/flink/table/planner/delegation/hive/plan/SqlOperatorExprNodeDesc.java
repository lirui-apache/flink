...
package org.apache.flink.table.planner.delegation.hive.plan;
...
public class SqlOperatorExprNodeDesc extends ExprNodeDesc {
	...
	public SqlOperatorExprNodeDesc(String funcName, SqlOperator sqlOperator, List<ExprNodeDesc> children, TypeInfo returnType) {
		super(returnType);
