...
public class HiveParserCreateViewDesc implements Serializable {
	...
	public HiveParserCreateViewDesc(String compoundName, List<FieldSchema> schema, String comment,
			Map<String, String> tblProps, boolean ifNotExists, boolean isAlterViewAs, ASTNode query) {
