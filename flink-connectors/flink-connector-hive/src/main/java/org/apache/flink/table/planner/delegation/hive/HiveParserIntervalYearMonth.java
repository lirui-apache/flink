	...
	public static HiveParserIntervalYearMonth valueOf(String strVal) {
		...
		if (patternMatcher.matches()) {
			...
			try {
				...
				int years = sign *
						HiveParserIntervalUtils.parseNumericValueWithRange("year", patternMatcher.group(2),
								0, Integer.MAX_VALUE);
				byte months = (byte) (sign *
						HiveParserIntervalUtils.parseNumericValueWithRange("month", patternMatcher.group(3), 0, 11));
