...
package org.apache.flink.table.planner.delegation.hive.optimizer.calcite.functions;
...
public class HiveParserSqlSumAggFunction extends SqlAggFunction implements HiveParserSqlFunctionConverter.CanAggregateDistinct {
	...
	public HiveParserSqlSumAggFunction(boolean isDistinct, SqlReturnTypeInference returnTypeInference,
	...
	class HiveSumSplitter extends SqlSplittableAggFunction.SumSplitter {
		...
		public AggregateCall other(RelDataTypeFactory typeFactory, AggregateCall e) {
			...
			return AggregateCall.create(
					new HiveParserSqlCountAggFunction(isDistinct, ReturnTypes.explicit(countRetType), operandTypeInference, operandTypeChecker),
		...
		public AggregateCall topSplit(RexBuilder rexBuilder,
			...
			return AggregateCall.create(new HiveParserSqlSumAggFunction(isDistinct, returnTypeInference, operandTypeInference, operandTypeChecker),
					false, Collections.singletonList(ordinal), -1, aggregateCall.type, aggregateCall.name);
		}
	}
}
