...
package org.apache.flink.table.planner.delegation.hive.lib;
...
public class HiveParserDefaultGraphWalker implements GraphWalker {
	...
	// opQueue keeps the nodes in the order that the were dispatched. Then it is used to go through the
