...
public class HiveParserAlterDatabaseDesc implements Serializable {
	...
	private HiveParserAlterDatabaseDesc(AlterDBType alterType, String databaseName, Map<String, String> dbProperties,
			PrincipalDesc ownerPrincipal, String location) {
	...
	private static class Builder {
		...
		HiveParserAlterDatabaseDesc build() {
			return new HiveParserAlterDatabaseDesc(alterType, databaseName, dbProperties, ownerPrincipal, location);
		}
	}
}
