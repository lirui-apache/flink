...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' into table src_truncate;;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' into table srcpart_truncate partition (ds='2008-04-08', hr='11');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' into table srcpart_truncate partition (ds='2008-04-08', hr='12');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' into table srcpart_truncate partition (ds='2008-04-09', hr='11');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' into table srcpart_truncate partition (ds='2008-04-09', hr='12');
