...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/smallsrcsortbucket3outof4.txt' INTO TABLE bucket_small partition(ds='2008-04-08');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/smallsrcsortbucket4outof4.txt' INTO TABLE bucket_small partition(ds='2008-04-08');

LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/smallsrcsortbucket1outof4.txt' INTO TABLE bucket_small partition(ds='2008-04-09');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/smallsrcsortbucket2outof4.txt' INTO TABLE bucket_small partition(ds='2008-04-09');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/smallsrcsortbucket3outof4.txt' INTO TABLE bucket_small partition(ds='2008-04-09');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/smallsrcsortbucket4outof4.txt' INTO TABLE bucket_small partition(ds='2008-04-09');
