...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/cbo_t1.txt' into table `c/b/o_t1` partition (dt='2014');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/cbo_t2.txt' into table `//cbo_t2` partition (dt='2014');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/cbo_t3.txt' into table `cbo_/t3////`;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/part_tiny.txt' overwrite into table `p/a/r/t`;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/lineitem.txt' OVERWRITE INTO TABLE `line/item`;
