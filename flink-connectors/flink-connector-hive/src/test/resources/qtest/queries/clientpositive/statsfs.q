...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' into table t1 partition (ds = '2010');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' into table t1 partition (ds = '2011');
