...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/emp.txt' OVERWRITE INTO TABLE emp;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/dept.txt' OVERWRITE INTO TABLE dept;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/loc.txt' OVERWRITE INTO TABLE loc;
