...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/store.txt' overwrite into table store;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/store.txt' overwrite into table store_bigint;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/store_sales.txt' overwrite into table store_sales;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/customer_address.txt' overwrite into table customer_address;
