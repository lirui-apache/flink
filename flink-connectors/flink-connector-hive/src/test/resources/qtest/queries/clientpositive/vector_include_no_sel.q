...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/store_sales.txt' OVERWRITE INTO TABLE store_sales_txt;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/customer_demographics.txt' OVERWRITE INTO TABLE customer_demographics_txt;
...
drop table if exists store_sales_txt;
