...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/pw17.txt' INTO TABLE PW18 PARTITION (YEAR='1');
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/pw17.txt' INTO TABLE PW18_2;
-- Without the fix HIVE-5202, will throw unsupported data type exception
