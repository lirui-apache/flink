...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/v1.txt' INTO TABLE atab PARTITION (dt='20130312', nt='tw');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/v1.txt' INTO TABLE atab PARTITION (dt='20130311', nt='tw');

DROP TABLE IF EXISTS  mstab;
CREATE TABLE  mstab(ks_uid INT, csc INT) PARTITIONED BY (dt STRING);
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/v2.txt' INTO TABLE mstab PARTITION (dt='20130311');
