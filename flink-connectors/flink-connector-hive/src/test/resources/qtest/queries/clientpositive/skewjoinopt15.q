...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/T1.txt' INTO TABLE tmpT1;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/T2.txt' INTO TABLE tmpT2;
