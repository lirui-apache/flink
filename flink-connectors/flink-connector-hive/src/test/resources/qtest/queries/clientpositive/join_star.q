...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/fact-data.txt' INTO TABLE fact;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/dim-data.txt' INTO TABLE dim1;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/dim-data.txt' INTO TABLE dim2;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/dim-data.txt' INTO TABLE dim3;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/dim-data.txt' INTO TABLE dim4;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/dim-data.txt' INTO TABLE dim5;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/dim-data.txt' INTO TABLE dim6;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/dim-data.txt' INTO TABLE dim7;
