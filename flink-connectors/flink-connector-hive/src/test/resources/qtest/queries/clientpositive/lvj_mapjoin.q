...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/sour1.txt' into table sour1;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}//sour2.txt' into table sour2;
...
drop table if exists tmp_lateral_view;
