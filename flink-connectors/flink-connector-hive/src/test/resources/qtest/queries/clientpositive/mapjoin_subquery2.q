...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/x.txt' INTO TABLE x;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/y.txt' INTO TABLE y;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/z.txt' INTO TABLE z;
