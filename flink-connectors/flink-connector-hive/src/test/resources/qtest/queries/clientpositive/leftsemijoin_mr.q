...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/leftsemijoin_mr_t1.txt' INTO TABLE T1;
CREATE TABLE T2(key INT);
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/leftsemijoin_mr_t2.txt' INTO TABLE T2;
