...
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee.dat" INTO TABLE Employee_Part partition(employeeSalary=2000.0);
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee.dat" INTO TABLE Employee_Part partition(employeeSalary=4000.0);
