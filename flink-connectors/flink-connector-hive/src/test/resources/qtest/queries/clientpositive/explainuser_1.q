...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/smbbucket_1.rc' into table src_rc_merge_test;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/in8.txt' INTO TABLE myinput1;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/in4.txt' into table smb_input;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/in5.txt' into table smb_input;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/sales.txt' INTO TABLE sales;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/things.txt' INTO TABLE things partition(ds='2011-10-23');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/things2.txt' INTO TABLE things partition(ds='2011-10-24');
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/T1.txt' INTO TABLE T4;
...
drop table if exists nzhang_tmp;

drop table if exists smb_input2;

drop table if exists part_4;

drop table if exists part_5;

drop view if exists cv1;

drop table if exists smb_input1;

drop table if exists smb_input;

drop table if exists nzhang_ctas1;

drop table if exists nzhang_ctas3;

drop table if exists acid_dtt;
