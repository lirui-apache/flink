...
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/test.dat" into table exim_department;
...
create table exim_department ( dep_id int comment "department id") 	
	...
	stored as textfile	
	tblproperties("creator"="krishna");
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/test.dat" into table exim_department partition (emp_org="hr");
