...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv2.txt' INTO TABLE T2;
CREATE TABLE T3(key INT, val STRING);
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv3.txt' INTO TABLE T3;
CREATE TABLE T4(key INT, val STRING);
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv5.txt' INTO TABLE T4;
