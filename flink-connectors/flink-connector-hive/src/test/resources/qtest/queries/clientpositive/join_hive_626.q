...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/hive_626_foo.txt' overwrite into table hive_foo;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/hive_626_bar.txt' overwrite into table hive_bar;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/hive_626_count.txt' overwrite into table hive_count;
