...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/over1k' overwrite into table over1k;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/over1k' into table over1k;
