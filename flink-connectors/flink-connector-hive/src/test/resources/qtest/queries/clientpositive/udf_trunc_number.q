...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/trunc_number.txt' INTO TABLE sampletable;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/trunc_number.txt' INTO TABLE sampletable1;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/trunc_number.txt' INTO TABLE sampletable2;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/trunc_number1.txt' INTO TABLE sampletable3;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/trunc_number1.txt' INTO TABLE sampletable4;
