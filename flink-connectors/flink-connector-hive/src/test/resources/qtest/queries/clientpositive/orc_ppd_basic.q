...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/over1k' OVERWRITE INTO TABLE staging;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/over1k' INTO TABLE staging;
...
drop table if exists orc_ppd;

drop table if exists orc_ppd_staging;
