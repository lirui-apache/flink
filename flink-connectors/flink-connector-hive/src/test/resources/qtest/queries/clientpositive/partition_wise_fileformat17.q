...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/pw17.txt' INTO TABLE PW17 PARTITION (YEAR='1');
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/pw17.txt' INTO TABLE PW17_2;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/pw17.txt' INTO TABLE PW17_3 PARTITION (YEAR='1');
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/pw17.txt' INTO TABLE PW17_4;
