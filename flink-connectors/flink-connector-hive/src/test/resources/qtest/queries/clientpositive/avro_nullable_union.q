...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/union_nullable.txt' INTO TABLE union_nullable_test_text;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/union_non_nullable.txt' INTO TABLE union_non_nullable_test_text;
