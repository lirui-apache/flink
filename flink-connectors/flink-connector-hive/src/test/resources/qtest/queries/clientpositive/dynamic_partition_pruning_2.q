...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/dim_shops.txt' into table dim_shops;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/agg_01-p1.txt' into table agg_01 partition (dim_shops_id=1);
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/agg_01-p2.txt' into table agg_01 partition (dim_shops_id=2);
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/agg_01-p3.txt' into table agg_01 partition (dim_shops_id=3);
