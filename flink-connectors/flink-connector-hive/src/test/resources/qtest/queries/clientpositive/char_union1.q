...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/vc1.txt' into table char_union1_ch1;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/vc1.txt' into table char_union1_ch2;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/vc1.txt' into table char_union1_str;
