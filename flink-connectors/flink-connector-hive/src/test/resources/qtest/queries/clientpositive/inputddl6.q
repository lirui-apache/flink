...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' INTO TABLE INPUTDDL6 PARTITION (ds='2008-04-09');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' INTO TABLE INPUTDDL6 PARTITION (ds='2008-04-08');
