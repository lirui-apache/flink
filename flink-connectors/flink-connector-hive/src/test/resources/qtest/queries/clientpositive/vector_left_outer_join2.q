...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/tjoin1.txt' OVERWRITE INTO TABLE TJOIN1STAGE;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/tjoin2.txt' OVERWRITE INTO TABLE TJOIN2STAGE;
