...
drop table if exists cmv_basetable;

drop materialized view if exists cmv_mat_view;

drop materialized view if exists cmv_mat_view3;

drop materialized view if exists cmv_mat_view2;

drop materialized view if exists cmv_mat_view4;

drop materialized view if exists cmv_mat_view5;
