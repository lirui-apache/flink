...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/T1.txt' into table smalltable;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/T1.txt' into table smalltable2;
...
drop table if exists smalltable2;
