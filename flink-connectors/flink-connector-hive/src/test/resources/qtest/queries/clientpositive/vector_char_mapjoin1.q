...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/vc1.txt' into table char_join1_vc1;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/vc1.txt' into table char_join1_vc2;
