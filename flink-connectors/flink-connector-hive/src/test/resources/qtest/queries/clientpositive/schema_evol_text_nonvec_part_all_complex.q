...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/schema_evolution/complex_struct1_a.txt' overwrite into table complex_struct1_a_txt;
...
collection items terminated by ','
map keys terminated by ':' stored as textfile;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/schema_evolution/complex_struct1_b.txt' overwrite into table complex_struct1_b_txt;
...
collection items terminated by ','
map keys terminated by ':' stored as textfile;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/schema_evolution/complex_struct1_c.txt' overwrite into table complex_struct1_c_txt;
...
collection items terminated by ','
map keys terminated by ':' stored as textfile;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/schema_evolution/complex_struct2_a.txt' overwrite into table complex_struct2_a_txt;
...
collection items terminated by ','
map keys terminated by ':' stored as textfile;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/schema_evolution/complex_struct2_b.txt' overwrite into table complex_struct2_b_txt;
...
collection items terminated by ','
map keys terminated by ':' stored as textfile;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/schema_evolution/complex_struct2_c.txt' overwrite into table complex_struct2_c_txt;
...
collection items terminated by ','
map keys terminated by ':' stored as textfile;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/schema_evolution/complex_struct2_d.txt' overwrite into table complex_struct2_d_txt;
...
collection items terminated by ','
map keys terminated by ':' stored as textfile;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/schema_evolution/complex_struct4_a.txt' overwrite into table complex_struct4_a_txt;
...
collection items terminated by ','
map keys terminated by ':' stored as textfile;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/schema_evolution/complex_struct4_b.txt' overwrite into table complex_struct4_b_txt;
...
collection items terminated by ','
map keys terminated by ':' stored as textfile;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/schema_evolution/complex_struct4_c.txt' overwrite into table complex_struct4_c_txt;
...
drop table if exists complex_struct4_c_txt;

drop table if exists complex_struct4_b_txt;

drop table if exists complex_struct4_a_txt;

drop table if exists complex_struct2_d_txt;

drop table if exists complex_struct1_a_txt;

drop table if exists complex_struct1_b_txt;

drop table if exists complex_struct1_c_txt;

drop table if exists complex_struct2_a_txt;

drop table if exists complex_struct2_b_txt;

drop table if exists complex_struct2_c_txt;
