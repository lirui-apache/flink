...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv9.txt' INTO TABLE DECIMAL_6_1;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv9.txt' INTO TABLE DECIMAL_6_2;
