...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/dynpartdata1.txt' into table sdp;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/dynpartdata2.txt' into table sdp;
