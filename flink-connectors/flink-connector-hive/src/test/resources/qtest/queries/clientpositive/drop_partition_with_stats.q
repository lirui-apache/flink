...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' OVERWRITE INTO TABLE testtable PARTITION (part1='p11', Part2='P12');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' OVERWRITE INTO TABLE testtable PARTITION (part1='p21', Part2='P22');
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' OVERWRITE INTO TABLE TestTable1 PARTITION (part1='p11', Part2='P11');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' OVERWRITE INTO TABLE TestTable1 PARTITION (part1='p11', Part2='P12');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' OVERWRITE INTO TABLE TestTable1 PARTITION (part1='p21', Part2='P22');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' OVERWRITE INTO TABLE TestTable1 PARTITION (part1='p31', Part2='P32');
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' OVERWRITE INTO TABLE TESTTABLE2 PARTITION (part1='p11', Part2='P12');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' OVERWRITE INTO TABLE TESTTABLE2 PARTITION (part1='p21', Part2='P22');
