...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/grouping_sets1.txt' INTO TABLE T1;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/grouping_sets2.txt' INTO TABLE T1;
