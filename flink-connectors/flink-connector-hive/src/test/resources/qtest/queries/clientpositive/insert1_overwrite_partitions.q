...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' INTO TABLE sourceTable partition(ds='2011-11-11', hr='11');

LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv3.txt' INTO TABLE sourceTable partition(ds='2011-11-11', hr='12');
