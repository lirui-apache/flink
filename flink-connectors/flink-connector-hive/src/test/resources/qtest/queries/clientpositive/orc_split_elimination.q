...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/orc_split_elim.orc' into table orc_split_elim;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/orc_split_elim.orc' into table orc_split_elim_part partition(country='us', year=2000);
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/orc_split_elim.orc' into table orc_split_elim_part partition(country='us', year=2001);
