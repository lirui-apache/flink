...
drop table if exists union_subq_union;

drop table if exists dst_union22;

drop table if exists dst_union22_delta;

drop table if exists tmp_srcpart;

drop table if exists union_out;

drop table if exists src10_1;

drop table if exists src10_2;

drop table if exists src10_3;

drop table if exists src10_4;
