...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/vc1.txt' into table varchar_union1_vc1;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/vc1.txt' into table varchar_union1_vc2;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/vc1.txt' into table varchar_union1_str;
