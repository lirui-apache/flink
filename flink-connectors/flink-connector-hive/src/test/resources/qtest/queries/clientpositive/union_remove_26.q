...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/T1.txt' into table inputSrcTbl1;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/T2.txt' into table inputSrcTbl2;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/T3.txt' into table inputSrcTbl3;
