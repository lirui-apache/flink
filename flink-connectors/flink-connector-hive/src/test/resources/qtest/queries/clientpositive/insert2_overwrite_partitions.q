...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' INTO TABLE db1.sourceTable partition(ds='2011-11-11');

LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv3.txt' INTO TABLE db1.sourceTable partition(ds='2011-11-11');
