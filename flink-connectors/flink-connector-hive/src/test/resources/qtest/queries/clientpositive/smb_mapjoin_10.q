...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/smbbucket_1.rc' INTO TABLE tmp_smb_bucket_10 partition(ds='1');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/smbbucket_2.rc' INTO TABLE tmp_smb_bucket_10 partition(ds='1');

LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/smbbucket_1.rc' INTO TABLE tmp_smb_bucket_10 partition(ds='2');
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/smbbucket_2.rc' INTO TABLE tmp_smb_bucket_10 partition(ds='2');
