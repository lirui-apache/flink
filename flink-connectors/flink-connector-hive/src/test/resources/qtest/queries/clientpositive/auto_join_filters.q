...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/in3.txt' INTO TABLE myinput1;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/in1.txt' into table smb_input1;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/in2.txt' into table smb_input1;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/in1.txt' into table smb_input2;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/in2.txt' into table smb_input2;
