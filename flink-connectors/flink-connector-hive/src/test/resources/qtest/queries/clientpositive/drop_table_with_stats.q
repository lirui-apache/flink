...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' OVERWRITE INTO TABLE testtable;
ANALYZE TABLE testtable COMPUTE STATISTICS FOR COLUMNS key;

CREATE TABLE IF NOT EXISTS TestTable1 (key STRING, value STRING);
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' OVERWRITE INTO TABLE TestTable1;
ANALYZE TABLE TestTable1 COMPUTE STATISTICS FOR COLUMNS key;

CREATE TABLE IF NOT EXISTS TESTTABLE2 (key STRING, value STRING);
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/kv1.txt' OVERWRITE INTO TABLE TESTTABLE2;
