...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/srcsortbucket1outof4.txt' INTO TABLE bucket;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/srcsortbucket2outof4.txt' INTO TABLE bucket;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/srcsortbucket3outof4.txt' INTO TABLE bucket;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/srcsortbucket4outof4.txt' INTO TABLE bucket;
