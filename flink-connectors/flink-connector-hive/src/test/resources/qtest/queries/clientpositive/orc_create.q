...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/orc_create.txt' OVERWRITE INTO TABLE orc_create_staging;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/orc_create_people.txt'
