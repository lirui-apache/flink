...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/lineitem.txt' OVERWRITE INTO TABLE lineitem_ix;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/tbl.txt' OVERWRITE INTO TABLE tbl;
