...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/TJOIN1' into table TJOIN1_txt;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/TJOIN2' into table TJOIN2_txt;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/TJOIN3' into table TJOIN3_txt;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/TJOIN4' into table TJOIN4_txt;
