...
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/UserVisits.dat" INTO TABLE UserVisits_web_text_none;
...
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/UserVisits.dat" INTO TABLE UserVisits_in_dummy_db;
