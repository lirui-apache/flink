...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/grouping_sets1.txt' INTO TABLE T1_text;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/grouping_sets2.txt' INTO TABLE T1_text;
