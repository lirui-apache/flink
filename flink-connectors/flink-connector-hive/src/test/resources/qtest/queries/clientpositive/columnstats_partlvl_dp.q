...
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee.dat"  INTO TABLE Employee_Part partition(employeeSalary='2000.0', country='USA');
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee2.dat" INTO TABLE Employee_Part partition(employeeSalary='2000.0', country='UK');
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee2.dat" INTO TABLE Employee_Part partition(employeeSalary='3000.0', country='USA');
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee2.dat" INTO TABLE Employee_Part partition(employeeSalary='4000.0', country='USA');
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee2.dat" INTO TABLE Employee_Part partition(employeeSalary='3500.0', country='UK');
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee.dat"  INTO TABLE Employee_Part partition(employeeSalary='3000.0', country='UK');
...
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee.dat"  INTO TABLE Employee partition(employeeSalary='2000.0', country='USA');
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee2.dat" INTO TABLE Employee partition(employeeSalary='2000.0', country='UK');
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee2.dat" INTO TABLE Employee partition(employeeSalary='3500.0', country='UK');
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee.dat"  INTO TABLE Employee partition(employeeSalary='3000.0', country='UK');
...
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee2.dat" INTO TABLE Employee partition(employeeSalary='3000.0', country='USA');
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee2.dat" INTO TABLE Employee partition(employeeSalary='4000.0', country='USA');
...
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/employee_part.txt"  INTO TABLE Employee partition(employeeSalary='6000.0', country='UK');
