...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/orc_split_elim.orc' overwrite into table ts_merge;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/orc_split_elim.orc' into table ts_merge;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/alltypesorc' into table a_merge;
