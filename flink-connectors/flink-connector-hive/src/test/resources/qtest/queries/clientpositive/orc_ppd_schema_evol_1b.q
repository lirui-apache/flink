...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/unique_1.txt' into table unique_1;
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/unique_2.txt' into table unique_2;
...
drop table if exists unique_1;

drop table if exists unique_2;

drop table if exists test_two_files;
