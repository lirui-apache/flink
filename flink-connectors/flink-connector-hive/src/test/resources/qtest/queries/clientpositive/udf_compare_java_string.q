...
create function test_udf_get_java_string AS 'org.apache.hadoop.hive.ql.udf.generic.GenericUDFTestGetJavaString';
...
drop function if exists test_udf_get_java_string;
