...
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/array_table.txt" overwrite into table array_table;
...
LOAD DATA LOCAL INPATH "${hiveconf:test.data.dir}/map_table.txt" overwrite into table map_table;
