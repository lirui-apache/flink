...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/empty1.txt' into table smb_bucket4_1;
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/empty2.txt' into table smb_bucket4_1;
...
drop table if exists smb_bucket4_1;

drop table if exists smb_bucket4_2;

drop table if exists smb_join_results;

drop table if exists normal_join_results;
