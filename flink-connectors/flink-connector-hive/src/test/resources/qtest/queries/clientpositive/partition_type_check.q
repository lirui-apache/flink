...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/T1.txt' overwrite into table tab1 PARTITION(month='June', day=2);
...
LOAD DATA LOCAL INPATH '${hiveconf:test.data.dir}/T1.txt' overwrite into table tab1 PARTITION(month='June', day='2008-01-01');
